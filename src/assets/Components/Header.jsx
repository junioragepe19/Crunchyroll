...
import { ArrowDropDown, Search, TurnedInNot, PersonOutlineRounded} from "@mui/icons-material";
...
export function Header(){
    ...
    return(
        <header className="w-100 h-14 bg-[#23252B] flex">
            ...
            <div className="flex h-full pl-[29rem]">
            <ul className="flex">
                    ...
                    <li className="hover:bg-[#141519] p-[0.3rem] cursor-pointer w-fit">
