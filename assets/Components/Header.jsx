...
export function Header(){
    ...
    return(
        <header className="absolute z-999 w-full h-14 bg-[#23252B] flex overflow-y-hidden overflow-x-hidden">
            ...
            <div className="flex h-full pl-2 z-30 font-medium">
                <ul className="flex">
            ...
            <div className="h-full flex  justify-items-end">
            <ul className="flex">
