...
import 'swiper/css';
import './general.css';
export function AnimesList({textoPrincipal, legenda, slides, colorBorder, distance}){
    return(
        <div className={`w-full absolute ` + distance}>
            <div className="w-[66rem] m-auto h-[28rem]  text-start text-white">
                ...
                <div className={`mt-4 border-t-[0.3rem] h-28 w-full`} style={{ borderTopColor: colorBorder }}>
